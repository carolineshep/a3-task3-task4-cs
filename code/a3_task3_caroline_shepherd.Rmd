...
ggplot(data = urchins_clean, aes(x = size)) + # Create ggplot
  geom_histogram(bins = 10, aes(fill = common_name)) + # Change number of bins from default to 10
...
urchin_stats %>% # Add caption to chart
  kable(caption = "Statistical Analysis of Sea Urchin Size (cm), Grouped by Species")
